...
def parse_arguments():
    ...
    parser.add_argument("--load_path", type=str,default='/hpc_stor03/sjtu_home/zhennan.shen/GNN/GATRec/save/2024-06-10 11:01:15_0.9451904611241511_model.pth', help="The path to load the model")
    ...
    parser.add_argument("--num_epochs", type=int, default=1000, help="The number of epochs to train for")
    ...
    parser.add_argument('--lr_period', default=40, type=int, help='period for lr_scheduler')
